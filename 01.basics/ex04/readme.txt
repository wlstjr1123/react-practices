...
1. webpack은 작제 분리된 많은 애플리케이션 모듈(css, js, images, font)들의 의존성을 분석해서 하나의 js파일로 묶은 도구
...
6. 설치 
    $ npm i -D webpack webpack-cli webpack-dev-server style-loder css-loader sass-loader
